    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
      <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
        ...
        <div className="w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
          <Breadcrumb class="sm:ml-0 gap-2">{param + " " + name}</Breadcrumb>
          ...
          <div className="flex justify-between items-center mt-6 ">
            {discount ? (
              <>
                ...
                <span className="bg-orange-500 py-3 px-8 text-white rounded-xl">
                  Discount:{""} {discount}
                </span>
              </>
            ) : (
          ...
          <button className="focus:outline-none focus:ring-2 hover:bg-orange-600 focus:ring-offset-2 focus:ring-orange-300 font-medium text-base leading-4 text-white bg-orange-500 w-full py-5 lg:mt-12 mt-6 dark:bg-orange-500 dark:hover:bg-orange-500 dark:focus:ring-orange-600">
            Add to cart
          </button>
        </div>
        ...
        <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
          <div className=" w-full lg:w-8/12 bg-gray-100 flex justify-center items-center">
            <Image src={image} alt={name} width={426} height={600} />
          </div>
          <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
            {images.map((img) => (
              <div
                ...
                key={name}
              >
                <Image src={img} alt={name} width={120} height={100} />
              </div>
            ))}
          </div>
        </div>
